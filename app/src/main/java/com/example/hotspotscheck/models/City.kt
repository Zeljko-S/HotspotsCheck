...
data class City(val id: String, val name: String, val img: String, val hotspots: List<Hotspot>, val hotstopnamelist: List<String>)
...
fun getCities(): List<City> {
    return listOf(
        City(
            ...
            hotspots = listOf(/*"https://marvel-b1-cdn.bc0a.com/f00000000179470/www.esbnyc.com/sites/default/files/styles/small_feature/public/2019-10/home_banner-min.jpg?itok=uZt-03Vw",
     ...
     /*   City(
            ...
            hotspots = listOf("https://bitmap.ticketlens.com/poi/265308607/1200x1200",
